...
angular.module('sigmaCabsApp')
    .controller('vehicleBookingTariff', function(oVehicleData, DispatchService, $scope, $dialog, dialog, wizardHandler, $http, PrerequisiteService, URLService, CustomerService, appUtils) {
