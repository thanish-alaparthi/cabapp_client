...
angular.module('sigmaCabsApp')
	.controller('vehicleBookingCancel', function(oVehicleData, DispatchService, $scope, $dialog, dialog, wizardHandler, $http, PrerequisiteService, URLService, CustomerService, appUtils) {
