/*
Name: PastBookingListController
Description: Handles displaying list (grid) of past bookings.
Date: 13Nov2013
...
angular.module('sigmaCabsApp')
	.controller('PastBookingListController', function($scope, $rootScope, URLService, $dialog, $http) {
		...
		*/
		$scope.fnGetPagedDataAsync = function(pageSize, page, searchText) {
			setTimeout(function() {
				$http.get(URLService.service('pastBooking'))
		...
		*/
		$scope.$on('loadPastBookingList', function(ev, oData) {
